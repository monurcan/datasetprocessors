...
"""
    This script directly converts COCO format to YOLO format.
    
    Example usage:
        python coco_to_yolo.py -j coco.json -o path_to_dir
"""
...
class COCO2YOLO:
    ...
    def _save_txt(self, anno_dict):
        for k, v in anno_dict.items():
            ...
            # file_name = v[0][0].split('/')[-1].split(".")[0] + ".txt"
